<%@ Page Language="C#" Title="Admin Register" AutoEventWireup="true" CodeBehind="AdminRegister.aspx.cs"
    Inherits="QuickDish.AdminRegister" MasterPageFile="~/Site.Master" %>
    ...
    <main class="py-5 my-2">
        <div class="container d-flex flex-column align-items-center justify-content-center">
            <section class="text-center">
                <h2 class="fw-bold text-black mb-5">Welcome Admin! Please Register</h2>
            </section>
